if (NOT COMMAND load_llvm)
  macro(load_llvm)
    ...
    set(CLANG_LIBRARIES clangBasic clangLex clangParse clangAST clangASTMatchers
      ...
      clangRewriteFrontend clangFrontendTool clangToolingCore clangToolingRefactor
      clangToolingASTDiff clangTooling clangIndex clangStaticAnalyzerCore
      clangStaticAnalyzerCheckers clangStaticAnalyzerFrontend clangFormat)
    add_library(llvm INTERFACE)
    target_link_libraries(llvm INTERFACE ${LLVM_LIBRARIES} ${CLANG_LIBRARIES})
